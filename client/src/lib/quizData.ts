...
export const pulmaoQuestions: Question[] = [];

export const rimQuestions: Question[] = [];

export const intestinoQuestions: Question[] = [];

export const estomagoQuestions: Question[] = [];

export const figadoQuestions: Question[] = [];

export const cerebroQuestions: Question[] = [];

export const ossoQuestions: Question[] = [];
...
export const quizzes: Quiz[] = [
  ...
  { id: "pulmao", title: "Pulmão", description: "Anatomia do sistema respiratório", emoji: "🫁", category: "Anatomia", questions: pulmaoQuestions },
  { id: "rim", title: "Rim", description: "Anatomia do sistema urinário", emoji: "🧪", category: "Anatomia", questions: rimQuestions },
  ...
  { id: "sna", title: "SNA e Membrana", description: "Sistema Nervoso Autônomo e Fisiologia de Membrana", emoji: "🧠⚡", category: "Fisiologia", questions: snaQuestions }
];
