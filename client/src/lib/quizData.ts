...
const toraxQuestions: Question[] = [
 ...
 },
 {
  ...
  options: ["Cartilagem cricoide.", "Manúbrio do esterno.", "Fúrcula esternal (abertura torácica superior).", "Vértebra cervical C7."],
  correctAnswer: 2,
  explanation: "O limite superior é definido pela fúrcula esternal.",
  theme: "Tórax"
 },
 {
  id: "torax-3",
  ...
  options: ["O esôfago torácico.", "O pericárdio.", "A traqueia torácica.", "A quarta vértebra torácica (T4)."],
  correctAnswer: 1,
  explanation: "O pericárdio serve como referência anatômica para a divisão do mediastino inferior.",
  theme: "Tórax"
 },
 {
  id: "torax-4",
  ...
  options: ["Veia ázigos.", "Tronco simpático.", "Bócio mergulhante da glândula tireoide.", "Coração e pericárdio."],
  correctAnswer: 2,
  explanation: "O bócio mergulhante é uma estrutura que pode ocupar o mediastino superior.",
  theme: "Tórax"
 },
 {
  id: "torax-5",
  ...
  options: ["Timo e raízes dos grandes vasos.", "Veia ázigos e ducto torácico.", "Hilos pulmonares e pericárdio.", "Traqueia torácica e nervo frênico."],
  correctAnswer: 1,
  explanation: "A veia ázigos e o ducto torácico são conteúdos típicos do mediastino posterior.",
  theme: "Tórax"
 },
 {
  id: "torax-6",
  ...
  options: ["Carina da traqueia.", "Hilo dos pulmões.", "Pleura mediastínica.", "Grande vaso da base."],
  correctAnswer: 1,
  explanation: "O hilo é onde os pulmões \"se beijam\" no mediastino médio.",
  theme: "Tórax"
 },
 {
  id: "torax-7",
  ...
  options: ["Apenas no mediastino superior.", "No superior e no inferior anterior.", "No inferior médio e posterior.", "Apenas no mediastino posterior."],
  correctAnswer: 1,
  explanation: "Topograficamente, o timo situa-se nos compartimentos superior e inferior anterior.",
  theme: "Tórax"
 },
 {
  id: "torax-8",
  ...
  options: ["Arcos costais.", "Esterno.", "Coluna vertebral torácica (coluna dorsal).", "Músculos intercostais."],
  correctAnswer: 2,
  explanation: "A coluna vertebral torácica constitui o limite posterior do mediastino.",
  theme: "Tórax"
 },
 {
  id: "torax-9",
  ...
  options: ["Ocorre no nível do processo xifoide.", "É feita por uma linha imaginária no nível da 4ª vértebra torácica (T4).", "O mediastino inferior termina no nível de T10.", "O mediastino superior contém o esôfago torácico em toda sua extensão."],
  correctAnswer: 1,
  explanation: "O plano transverso do tórax (ângulo de Louis) situa-se ao nível de T4.",
  theme: "Tórax"
 },
 {
  id: "torax-10",
  question: "A inervação motora do músculo diafragma é suprida por qual estrutura nervosa?",
  options: ["Nervo vago.", "Nervo frênico.", "Nervo intercostal.", "Nervo hipoglosso."],
  correctAnswer: 1,
  explanation: "O nervo frênico fornece a inervação motora para o diafragma.",
  theme: "Tórax"
 },
 {
  id: "torax-11",
  question: "Sobre as características anatômicas da pleura visceral, é correto afirmar que:",
  options: ["Ela reveste a parede interna da caixa torácica.", "É sensível à dor através dos nervos intercostais.", "É aderida intrinsecamente ao parênquima pulmonar e não pode ser descolada.", "É vascularizada exclusivamente pela artéria torácica interna."],
  correctAnswer: 2,
  explanation: "A pleura visceral é intimamente aderida ao parênquima pulmonar.",
  theme: "Tórax"
 },
 {
  id: "torax-12",
  ...
  options: ["Acúmulo de líquido por desequilíbrio de absorção.", "Presença de sangue por trauma.", "Presença de ar, tornando o espaço real.", "Acúmulo de linfa por lesão do ducto torácico."],
  correctAnswer: 2,
  explanation: "A presença de ar no espaço pleural converte a cavidade virtual em real.",
  theme: "Tórax"
 },
 {
  id: "torax-13",
  ...
  options: ["Manter a pressão positiva para facilitar a expiração.", "Manter a pressão negativa (subatmosférica) para evitar o colabamento pulmonar.", "Igualar a pressão pulmonar à pressão atmosférica.", "Produzir 1000 ml de líquido pleural por minuto."],
  correctAnswer: 1,
  explanation: "A pressão intrapleural negativa é essencial para prevenir o colabamento pulmonar.",
  theme: "Tórax"
 },
 {
  id: "torax-14",
  question: "Um paciente apresenta uma \"dor pleurítica\". Qual camada da pleura é sensível à dor e por quais nervos?",
  options: ["Pleura visceral; plexo pulmonar.", "Pleura parietal; nervos intercostais e nervo frênico.", "Pleura parietal mediastínica; apenas nervo vago.", "Ambas as pleuras são igualmente sensíveis."],
  correctAnswer: 1,
  explanation: "A pleura parietal possui inervação somática, sendo a camada sensível à dor.",
  theme: "Tórax"
 },
 {
  id: "torax-15",
  question: "Em relação aos recessos pleurais, qual deles \"some\" ou desaparece especificamente em casos de pneumotórax (ar)?",
  options: ["Recesso costofrênico.", "Recesso cardiofrênico.", "Recesso apical.", "Recesso diafragmático."],
  correctAnswer: 2,
  explanation: "No pneumotórax, o recesso apical é tipicamente o primeiro a ser obliterado.",
  theme: "Tórax"
 },
 {
  id: "torax-16",
  question: "O \"selo d'água\" é um mecanismo mencionado na aula para drenagem torácica. Sua função principal é:",
  options: ["Lavar a cavidade pleural.", "Impedir a comunicação do meio exterior com a cavidade (evitar que o ar entre).", "Produzir líquido pleural artificial.", "Aumentar a pressão negativa durante a inspiração."],
  correctAnswer: 1,
  explanation: "O sistema de selo d'água atua como uma válvula unidirecional que impede o refluxo de ar para o tórax.",
  theme: "Tórax"
 },
 {
  id: "torax-17",
  question: "O suprimento arterial da porção diafragmática da pleura parietal é provido predominantemente por qual vaso?",
  options: ["Artéria torácica interna.", "Artéria intercostal.", "Artéria brônquica.", "Artéria musculofrênica."],
  correctAnswer: 3,
  explanation: "A artéria musculofrênica é responsável pela irrigação desta área.",
  theme: "Tórax"
 },
 {
  id: "torax-18",
  ...
  options: ["Pneumonia.", "Insuficiência cardíaca.", "Trauma (acidentes de carro, arma branca).", "Câncer de pulmão avançado."],
  correctAnswer: 2,
  explanation: "O trauma torácico é a principal etiologia do hemotórax.",
  theme: "Tórax"
 },
 {
  id: "torax-19",
  question: "A irrigação arterial da pleura parietal em sua face mediastinal é derivada de qual vaso?",
  options: ["Artéria torácica interna.", "Artéria brônquica.", "Artéria musculofrenica.", "Artéria aorta descendente."],
  correctAnswer: 0,
  explanation: "A irrigação da pleura mediastínica provém da artéria torácica interna.",
  theme: "Tórax"
 },
 {
  id: "torax-20",
  question: "Como o professor descreve os \"recessos pleurais\"?",
  options: ["Espaços que nunca somem, mesmo em doenças.", "Cavidades no espaço pleural que aparecem durante a expiração.", "Estruturas que fixam o pulmão ao diafragma.", "Locais de entrada dos brônquios principais."],
  correctAnswer: 1,
  explanation: "Os recessos pleurais funcionam como espaços de reserva durante a mecânica respiratória.",
  theme: "Tórax"
 },
 {
  id: "torax-21",
  question: "Anatomicamente, o pulmão direito diferencia-se do esquerdo por apresentar:",
  options: ["dois lobos e menor peso relativo.", "três lobos e duas fissuras (horizontal e oblíqua).", "incisura cardíaca e língula.", "formato mais alongado e estreito."],
  correctAnswer: 1,
  explanation: "Morfologicamente, o pulmão direito é composto por três lobos e duas fissuras.",
  theme: "Tórax"
 },
 {
  id: "torax-22",
  ...
  options: ["Carina.", "Incisura cardíaca.", "Língula.", "Base pulmonar."],
  correctAnswer: 2,
  explanation: "A língula é a projeção do lobo superior esquerdo análoga ao lobo médio direito.",
  theme: "Tórax"
 },
 {
  id: "torax-23",
  ...
  options: ["Artéria, Brônquio, Veia (ABV).", "Brônquio, Artéria, Veia (BAV).", "Veia, Artéria, Brônquio (VAB).", "Veia, Brônquio, Artéria (VBA)."],
  correctAnswer: 1,
  explanation: "No hilo pulmonar direito, a disposição craniocaudal é Brônquio, Artéria e Veia.",
  theme: "Tórax"
 },
 {
  id: "torax-24",
  question: "No hilo pulmonar esquerdo, qual a organização anatômica das estruturas principais no sentido superoinferior?",
  options: ["Artéria, Brônquio, Veia (ABV).", "Brônquio, Artéria, Veia (BAV).", "Veia, Brônquio, Artéria.", "Artéria, Veia, Brônquio."],
  correctAnswer: 0,
  explanation: "No hilo pulmonar esquerdo, a disposição craniocaudal é Artéria, Brônquio e Veia.",
  theme: "Tórax"
 },
 {
  id: "torax-25",
  ...
  options: ["Maior comprimento e disposição horizontal.", "Menor comprimento e maior verticalidade.", "Devido à presença da carina desviada para a direita.", "Porque o brônquio esquerdo é mais calibroso."],
  correctAnswer: 1,
  explanation: "O brônquio principal direito apresenta maior verticalidade e menor comprimento que o esquerdo.",
  theme: "Tórax"
 },
 {
  id: "torax-26",
  question: "A traqueia é um conduto fibrocartilaginoso que se estende longitudinalmente entre quais níveis anatômicos?",
  options: ["Da laringe até T12.", "Da cartilagem tireoide até os brônquios lobares.", "Da cartilagem cricoide até a carina.", "Do osso hioide até o manúbrio."],
  correctAnswer: 2,
  explanation: "A traqueia estende-se da cartilagem cricoide até a sua bifurcação na carina.",
  theme: "Tórax"
 },
 {
  id: "torax-27",
  ...
  options: ["Traqueia → Carina → Brônquio Principal → Brônquio Lobar → Brônquio Segmentar → Bronquíolos → Alvéolos.", "Traqueia → Brônquio Segmentar → Brônquio Lobar → Bronquíolo.", "Carina → Bronquíolo Terminal → Brônquio Principal.", "Brônquio Principal → Alvéolo → Bronquíolo."],
  correctAnswer: 0,
  explanation: "Representa a segmentação anatômica correta da árvore brônquica.",
  theme: "Tórax"
 },
 {
  id: "torax-28",
  question: "A hematose, ou troca gasosa alvéolo-capilar, ocorre predominantemente em quais estruturas do parênquima pulmonar?",
  options: ["Nos brônquios principais.", "Nos brônquios lobares.", "Nos bronquíolos terminais e alvéolos.", "Na carina."],
  correctAnswer: 2,
  explanation: "A troca gasosa ocorre nas unidades alveolares e bronquíolos respiratórios.",
  theme: "Tórax"
 },
 {
  id: "torax-29",
  question: "O professor menciona a \"Asma Brônquica\". Qual o problema anatômico descrito por ele nessa condição?",
  options: ["Ruptura dos alvéolos por pressão negativa.", "Dificuldade na passagem do ar devido ao edema da árvore brônquica.", "Presença de líquido no espaço pleural.", "Fibrose das artérias pulmonares."],
  correctAnswer: 1,
  explanation: "A asma brônquica caracteriza-se por inflamação e broncoconstrição reversível.",
  theme: "Tórax"
 },
 {
  id: "torax-30",
  question: "No pulmão direito, a fissura horizontal estabelece o limite anatômico entre quais lobos?",
  options: ["Lobo médio do inferior.", "Lobo superior do inferior.", "Lobo superior do médio.", "Não existe fissura horizontal no pulmão direito."],
  correctAnswer: 2,
  explanation: "A fissura horizontal delimita os lobos superior e médio do pulmão direito.",
  theme: "Tórax"
 },
 {
  id: "torax-31",
  question: "Sobre o sistema linfático, qual a definição de \"Cisterna do Quilo\"?",
  options: ["Local onde desemboca o ducto torácico.", "Parte mais dilatada do sistema linfático, onde se forma o ducto torácico.", "Conjunto de linfonodos localizados no hilo pulmonar.", "Vaso que drena a linfa da face e pescoço."],
  correctAnswer: 1,
  explanation: "A cisterna do quilo é a origem dilatada do ducto torácico.",
  theme: "Tórax"
 },
 {
  id: "torax-32",
  ...
  options: ["Veia cava superior.", "Veia ázigos.", "Junção das veias subclávia e jugular interna esquerdas.", "Átrio direito."],
  correctAnswer: 2,
  explanation: "O ducto torácico drena para a confluência venosa jugulo-subclávia esquerda.",
  theme: "Tórax"
 },
 {
  id: "torax-33",
  ...
  options: ["Veia renal e veia porta.", "Veia lombar ascendente e subcostal esquerda.", "Veia intercostal anterior e posterior.", "Veia cava inferior e superior."],
  correctAnswer: 1,
  explanation: "Descreve os vasos que convergem para formar a veia hemiázigos.",
  theme: "Tórax"
 },
 {
  id: "torax-34",
  ...
  options: ["Ducto torácico.", "Troncos vagais anterior e posterior.", "Veia ázigos.", "Artéria aorta."],
  correctAnswer: 1,
  explanation: "O esôfago e os troncos vagais atravessam o diafragma ao nível de T10.",
  theme: "Tórax"
 },
 {
  id: "torax-35",
  ...
  options: ["Aorta, ducto torácico e veia ázigos.", "Aorta e nervo frênico.", "Veia cava inferior e nervos vagos.", "Apenas a artéria aorta."],
  correctAnswer: 0,
  explanation: "A aorta, o ducto torácico e a veia ázigos utilizam o hiato aórtico (T12).",
  theme: "Tórax"
 },
 {
  id: "torax-36",
  ...
  options: ["Artéria aorta torácica.", "Artéria subclávia.", "Artéria carótida comum.", "Artéria brônquica."],
  correctAnswer: 1,
  explanation: "A artéria torácica interna é um ramo descendente da artéria subclávia.",
  theme: "Tórax"
 },
 {
  id: "torax-37",
  question: "A maioria das artérias intercostais posteriores (do 3º ao 11º espaço) origina-se diretamente de qual vaso?",
  options: ["Artéria torácica interna.", "Artéria musculofrênica.", "Artéria aorta descendente (torácica).", "Veia ázigos."],
  correctAnswer: 2,
  explanation: "As artérias intercostais posteriores originam-se da face posterior da aorta torácica.",
  theme: "Tórax"
 },
 {
  id: "torax-38",
  question: "Qual é a terminologia oncológica correta para designar as neoplasias malignas primárias do sistema linfático?",
  options: ["Carcinoma.", "Linfoma.", "Sarcoma.", "Linfadenite."],
  correctAnswer: 1,
  explanation: "O termo linfoma designa neoplasias malignas do tecido linfoide.",
  theme: "Tórax"
 },
 {
  id: "torax-39",
  ...
  options: ["T4.", "T8-T9.", "T10.", "T12."],
  correctAnswer: 1,
  explanation: "O forame da veia cava inferior localiza-se ao nível de T8.",
  theme: "Tórax"
 },
 {
  id: "torax-40",
  ...
  options: ["Veia hemiázigos.", "Veia torácica interna.", "Veia ázigos.", "Veia jugular externa."],
  correctAnswer: 2,
  explanation: "A veia ázigos é o principal vaso de drenagem da parede torácica direita para a veia cava superior.",
  theme: "Tórax"
 }
];
  ...
  questions: [
   {
    ...
    correctAnswer: 1,
    explanation: "O trago é a saliência à frente do meato; dor à pressão (sinal do trago) indica otite externa.",
    theme: "Orelha"
   },
   {
    id: "orelha-2",
    ...
    correctAnswer: 1,
    explanation: "O pavilhão auricular capta e direciona as ondas sonoras para o meato.",
    theme: "Orelha"
   },
   {
    id: "orelha-3",
    ...
    correctAnswer: 2,
    explanation: "O meato acústico externo tem o terço lateral cartilagíneo e os dois terços mediais ósseos.",
    theme: "Orelha"
   },
   {
    id: "orelha-4",
    ...
    correctAnswer: 1,
    explanation: "Glândulas ceruminosas e sebáceas no meato acústico externo produziram o cerume.",
    theme: "Orelha"
   },
   {
    id: "orelha-5",
    ...
    correctAnswer: 2,
    explanation: "A membrana timpânica é o limite físico entre a orelha externa e a média.",
    theme: "Orelha"
   },
   {
    id: "orelha-6",
    ...
    correctAnswer: 1,
    explanation: "O lóbulo é vascularizado e não possui cartilagem, sendo ideal para coletas rápidas.",
    theme: "Orelha"
   },
   {
    id: "orelha-7",
    ...
    correctAnswer: 2,
    explanation: "O tímpano tem revestimento cutâneo externo e mucoso interno.",
    theme: "Orelha"
   },
   {
    id: "orelha-8",
    ...
    correctAnswer: 2,
    explanation: "A tuba auditiva equaliza a pressão da orelha média com a atmosférica.",
    theme: "Orelha"
   },
   {
    id: "orelha-9",
    ...
    correctAnswer: 2,
    explanation: "A orelha média modula o som, transformando alta em baixa amplitude.",
    theme: "Orelha"
   },
   {
    id: "orelha-10",
    ...
    correctAnswer: 1,
    explanation: "As estruturas da orelha estão nas porções timpânica e petrosa do osso temporal.",
    theme: "Orelha"
   },
   {
    id: "orelha-11",
    ...
    correctAnswer: 1,
    explanation: "A sequência é Martelo (no tímpano), Bigorna (intermediário) e Estribo (na janela oval).",
    theme: "Orelha"
   },
   {
    id: "orelha-12",
    ...
    correctAnswer: 2,
    explanation: "A tuba auditiva liga a orelha média à nasofaringe (faringe superior).",
    theme: "Orelha"
   },
   {
    id: "orelha-13",
    ...
    correctAnswer: 1,
    explanation: "O músculo estapédio ancora-se no estribo e é suprido pelo nervo facial (VII).",
    theme: "Orelha"
   },
   {
    id: "orelha-14",
    ...
    correctAnswer: 1,
    explanation: "O tensor do tímpano ancora-se no martelo e é suprido pelo trigêmeo (V3).",
    theme: "Orelha"
   },
   {
    id: "orelha-15",
    ...
    correctAnswer: 2,
    explanation: "O nervo vestibulococlear (VIII) coordena a audição e o equilíbrio.",
    theme: "Orelha"
   },
   {
    id: "orelha-16",
    ...
    correctAnswer: 2,
    explanation: "A perilinfa preenche o espaço entre o labirinto ósseo e o membranáceo.",
    theme: "Orelha"
   },
   {
    id: "orelha-17",
    ...
    correctAnswer: 1,
    explanation: "Vestíbulo e canais semicirculares detectam posição e movimento (equilíbrio).",
    theme: "Orelha"
   },
   {
    id: "orelha-18",
    ...
    correctAnswer: 1,
    explanation: "A base do estribo encaixa-se na janela oval do vestíbulo.",
    theme: "Orelha"
   },
   {
    id: "orelha-19",
    ...
    correctAnswer: 2,
    explanation: "A cóclea transforma sinais mecânicos em elétricos para a audição.",
    theme: "Orelha"
   },
   {
    id: "orelha-20",
    ...
    correctAnswer: 1,
    explanation: "O interior do labirinto membranáceo é preenchido por endolinfa.",
    theme: "Orelha"
   },
   {
    id: "orelha-21",
    ...
    correctAnswer: 1,
    explanation: "A inervação externa envolve V3, X e ramos cervicais (C2/C3).",
    theme: "Orelha"
   },
   {
    id: "orelha-22",
    ...
    correctAnswer: 2,
    explanation: "Divide-se em cavidade timpânica propriamente dita e recesso epitimpânico.",
    theme: "Orelha"
   },
   {
    id: "orelha-23",
    ...
    correctAnswer: 1,
    explanation: "Utrículo e sáculo fazem parte do labirinto membranáceo voltado ao equilíbrio.",
    theme: "Orelha"
   },
   {
    id: "orelha-24",
    ...
    correctAnswer: 1,
    explanation: "A artéria labiríntica vem da artéria basilar (sistema vértebro-basilar).",
    theme: "Orelha"
   },
   {
    id: "orelha-25",
    ...
    correctAnswer: 1,
    explanation: "A membrana timpânica secundária localiza-se na janela redonda da cóclea.",
    theme: "Orelha"
   },
   {
    id: "orelha-26",
    ...
    correctAnswer: 1,
    explanation: "A veia labiríntica drena para a veia cerebelar e seios durais.",
    theme: "Orelha"
   },
   {
    id: "orelha-27",
    ...
    correctAnswer: 1,
    explanation: "A sensibilidade da orelha média é feita pelo glossofaríngeo (IX).",
    theme: "Orelha"
   },
   {
    id: "orelha-28",
    ...
    correctAnswer: 2,
    explanation: "A concha é a depressão profunda que leva ao meato acústico externo.",
    theme: "Orelha"
   },
   {
    id: "orelha-29",
    ...
    correctAnswer: 1,
    explanation: "O labirinto ósseo é revestido por periósteo.",
    theme: "Orelha"
   },
   {
    id: "orelha-30",
    ...
    correctAnswer: 1,
    explanation: "Os sinais elétricos da audição são levados ao córtex temporal.",
    theme: "Orelha"
   }
  ]
 },
 {
  ...
  questions: [
   ...
   },
   {
    ...
    options: ['Seu limite superior é definido pela margem inferior da cartilagem cricoide.', 'O istmo das fauces representa sua comunicação anterior com a cavidade oral.', 'Localiza-se posteriormente à cavidade nasal e acima do palato mole.', 'Sua parede posterior está relacionada ao nível das vértebras C4 a C6.'],
    correctAnswer: 1,
   ...
   },
   {
    ...
    options: ['São três músculos intrínsecos de disposição circular.', 'O músculo constritor superior ajuda a formar a parede lateral da nasofaringe.', 'O músculo constritor médio insere-se no corno maior do osso hioide.', 'Todos os três constritores são inervados exclusivamente pelo nervo glossofaríngeo.'],
    correctAnswer: 3,
   ...
   },
   {
    ...
    correctAnswer: 2,
    explanation: "O recesso piriforme é uma depressão lateral ao ádito da laringe onde corpos estranhos frequentemente se alojam.",
    theme: "Faringe"
   },
   {
    id: "faringe-5",
    question: "Assinale a alternativa INCORRETA sobre a vascularização arterial da faringe:",
    options: ['A faringe superior é irrigada por ramos da artéria carótida externa.', 'A artéria faríngea ascendente é um dos principais suprimentos da parte superior.', 'A artéria tireóidea superior fornece ramos para a faringe inferior.', 'A artéria subclávia é a origem direta de todos os vasos que irrigam a nasofaringe.'],
    correctAnswer: 3,
   ...
   },
   {
    ...
    options: ['As tonsilas palatinas localizam-se lateralmente na orofaringe.', 'As tonsilas tubárias estão localizadas próximas ao óstio da tuba auditiva.', 'A tonsila lingual compõe a parte anteroinferior na raiz da língua.', 'Todas as tonsilas do anel estão localizadas exclusivamente na laringofaringe.'],
    correctAnswer: 3,
   ...
   },
   {
    ...
    correctAnswer: 1,
    explanation: "O estilofaríngeo é o único músculo da faringe inervado pelo nervo glossofaríngeo (IX); os demais são pelo vago (X).",
    theme: "Faringe"
   },
   {
    id: "faringe-8",
    ...
    correctAnswer: 3,
    explanation: "A prega vocal localiza-se na laringe, não na parede lateral da nasofaringe.",
    theme: "Faringe"
   },
   {
    id: "faringe-9",
    question: "Assinale a alternativa que descreve CORRETAMENTE a inervação sensitiva da faringe:",
    options: ['A nasofaringe é suprida pelo ramo maxilar (V2) do nervo trigêmeo.', 'A orofaringe é suprida pelo nervo vago.', 'A laringofaringe é inervada pelo nervo glossofaríngeo.', 'O nervo facial é o principal responsável pela sensibilidade da mucosa faríngea.'],
    correctAnswer: 0,
   ...
   },
   {
    ...
    options: ['Estende-se da base do crânio até o palato mole.', 'Comunica-se anteriormente com o ádito da laringe.', 'Situa-se ao nível das vértebras C1 e C2.', 'É irrigada principalmente pela artéria maxilar.'],
    correctAnswer: 1,
   ...
   },
   {
    ...
    correctAnswer: 1,
    explanation: "O músculo salpingofaríngeo origina-se na parte cartilaginosa da tuba auditiva.",
    theme: "Faringe"
   },
   {
    id: "faringe-12",
    ...
    correctAnswer: 1,
    explanation: "O plexo venoso faríngeo drena diretamente para a veia jugular interna.",
    theme: "Faringe"
   },
   {
    id: "faringe-13",
    question: "Assinale a alternativa INCORRETA sobre o osso hioide:",
    options: ['Não se articula diretamente com outros ossos.', 'Possui um corpo, cornos maiores e cornos menores.', 'Participa da mastigação, fala e deglutição.', 'Faz parte do esqueleto cartilaginoso da laringofaringe.'],
    correctAnswer: 3,
   ...
   },
   {
    ...
    correctAnswer: 1,
    explanation: "O palato mole eleva-se para fechar o istmo faríngeo, separando as duas partes.",
    theme: "Faringe"
   },
   {
    id: "faringe-15",
    ...
    correctAnswer: 2,
    explanation: "Esses são os limites anatômicos da abertura anterior da orofaringe.",
    theme: "Faringe"
   },
   {
    id: "faringe-16",
    question: "Sobre os músculos extrínsecos da faringe, assinale a alternativa CORRETA:",
    options: ['Atuam como constritores do lúmen faríngeo.', 'São eles: o estilofaríngeo, salpingofaríngeo e palatofaríngeo.', 'Todos possuem fibras circulares.', 'São inervados apenas pelo nervo hipoglosso.'],
    correctAnswer: 1,
   ...
   },
   {
    ...
    correctAnswer: 1,
    explanation: "A faringe mede entre 12 e 14 cm de comprimento.",
    theme: "Faringe"
   },
   {
    id: "faringe-18",
    ...
    options: ['C2.', 'C4.', 'C6.', 'T2.'],
    correctAnswer: 2,
    explanation: "A transição ocorre na margem inferior da cartilagem cricoide, ao nível de C6.",
    theme: "Faringe"
   },
   {
    id: "faringe-19",
    ...
    correctAnswer: 2,
    explanation: "Faz parte da complexa parede lateral da nasofaringe.",
    theme: "Faringe"
   },
   {
    id: "faringe-20",
    ...
    correctAnswer: 2,
    explanation: "Os músculos extrínsecos/longitudinais (como o estilofaríngeo) elevam a faringe.",
    theme: "Faringe"
   }
  ]
 },
  ...
  questions: [
   {
    ...
    options: ['Estende-se da base do crânio até a vértebra C3.', 'Vai da margem superior da epiglote até a margem inferior da cartilagem cricoide.', 'Localiza-se entre as vértebras T1 e T4.', 'Inicia-se nas coanas e termina no istmo das fauces.'],
    correctAnswer: 1,
   ...
   },
   {
    ...
    correctAnswer: 2,
    explanation: "A epiglote atua fechando a entrada da laringe para evitar aspiração.",
    theme: "Laringe"
   },
   {
    id: "laringe-23",
    ...
    options: ['Sensibilidade da mucosa acima das pregas vocais.', 'Abdução (abertura) das pregas vocais pelo músculo cricoaritenóideo posterior.', 'Tensão das pregas vocais pelo músculo cricotireóideo, afetando sons agudos.', 'Sensibilidade de toda a laringofaringe.'],
    correctAnswer: 2,
   ...
   },
   {
    ...
    options: ['Possui formato de escudo.', 'É formada por duas lâminas quadriláteras.', 'A fusão dos seus 2/3 inferiores forma a proeminência laríngea (pomo de Adão).', 'Articula-se inferiormente com o osso hioide por uma articulação sinovial.'],
    correctAnswer: 3,
   ...
   },
   {
    ...
    correctAnswer: 2,
    explanation: "A cricoide é caracterizada pelo arco anterior estreito e lâmina posterior larga.",
    theme: "Laringe"
   },
   {
    id: "laringe-26",
    ...
    options: ['Ápice da cartilagem.', 'Fóvea triangular (superior).', 'Fóvea oblonga (inferior).', 'Processo muscular lateral.'],
    correctAnswer: 2,
   ...
   },
   {
    ...
    options: ['Cricoaritenóideo lateral.', 'Cricoaritenóideo posterior.', 'Cricotireóideo.', 'Tireoaritenóideo.'],
    correctAnswer: 1,
    explanation: "O cricoaritenóideo posterior é conhecido como o \"músculo da respiração\" por ser o único abdutor.",
    theme: "Laringe"
   },
   {
    id: "laringe-28",
    question: "Sobre a vascularização da laringe, assinale a alternativa CORRETA:",
    options: ['A artéria laríngea superior é ramo da artéria tireóidea inferior.', 'A artéria laríngea inferior deriva do tronco tireocervical, via artéria tireóidea inferior.', 'Toda a drenagem venosa da laringe ocorre para a veia subclávia direita.', 'A artéria tireóidea ima é o principal suprimento da laringe superior.'],
    correctAnswer: 1,
   ...
   },
   {
    ...
    options: ['Membrana cricovocal (cone elástico).', 'Membrana tireo-hióidea.', 'Membrana quadrangular.', 'Membrana cricotireóidea.'],
    correctAnswer: 1,
    explanation: "A membrana tireo-hióidea possui uma abertura para o nervo laríngeo interno e a artéria laríngea superior.",
    theme: "Laringe"
   },
   {
    id: "laringe-30",
    question: "Qual compartimento da cavidade laríngea situa-se entre as pregas vestibulares e as pregas vocais?",
    options: ['Vestíbulo laríngeo.', 'Cavidade infraglótica.', 'Ventrículo laríngeo.', 'Adito da laringe.'],
    correctAnswer: 2,
    explanation: "O ventrículo é o espaço médio entre as pregas superiores (vestibulares) e inferiores (vocais).",
    theme: "Laringe"
   },
   {
    id: "laringe-31",
    question: "Sobre a inervação sensitiva da laringe, assinale a alternativa INCORRETA:",
    options: ['Acima das pregas vocais, a sensibilidade é dada pelo nervo laríngeo interno.', 'Abaixo das pregas vocais, a sensibilidade é dada pelo nervo laríngeo recorrente.', 'O nervo glossofaríngeo é o principal responsável pela tosse laríngea.', 'O nervo vago é a origem comum de ambos os nervos laríngeos.'],
    correctAnswer: 2,
   ...
   },
   {
    ...
    correctAnswer: 1,
    explanation: "Elas situam-se sobre os ápices das aritenoides.",
    theme: "Laringe"
   },
   {
    id: "laringe-33",
    question: "Qual músculo relaxa e encurta a prega vocal, produzindo sons mais graves?",
    options: ['Cricotireóideo.', 'Tireoaritenóideo (e músculo vocal).', 'Ariepiglótico.', 'Constritor superior.'],
    correctAnswer: 1,
    explanation: "Esses músculos agem reduzindo a tensão das pregas vocais.",
    theme: "Laringe"
   },
   {
    id: "laringe-34",
    question: "A margem livre inferior da \"membrana quadrangular\" espessa-se para formar qual estrutura?",
    options: ['Ligamento vocal.', 'Ligamento vestibular.', 'Ligamento cricotireóideo mediano.', 'Prega salpingofaríngea.'],
    correctAnswer: 1,
    explanation: "A margem inferior da membrana quadrangular é o ligamento vestibular (prega vocal falsa).",
    theme: "Laringe"
   },
   {
    id: "laringe-35",
    question: "A \"Rima Glótica\" ou Glote é definida como:",
    options: ['O espaço entre a epiglote e a língua.', 'A abertura superior da laringe (ádito).', 'A fissura entre as pregas vocais e as cartilagens aritenoides.', 'O canal entre a laringe e o esôfago.'],
    correctAnswer: 2,
    explanation: "É a abertura variável entre as estruturas da fonação.",
    theme: "Laringe"
   },
   {
    id: "laringe-36",
    question: "Qual estrutura é formada pelo espessamento mediano da membrana cricotireóidea?",
    options: ['Ligamento tireo-hióideo lateral.', 'Ligamento cricotireóideo mediano.', 'Ligamento vocal.', 'Prega ariepiglótica.'],
    correctAnswer: 1,
    explanation: "Local onde se realiza o acesso de urgência à via aérea.",
    theme: "Laringe"
   },
   {
    id: "laringe-37",
    question: "Onde se localizam as cartilagens cuneiformes?",
    options: ['No interior do ligamento vocal.', 'No ápice da cartilagem cricoide.', 'Nas pregas ariepiglóticas, acima das aritenoides.', 'No istmo da glândula tireoide.'],
    correctAnswer: 2,
    explanation: "São nódulos em forma de baqueta nas pregas ariepiglóticas.",
    theme: "Laringe"
   },
   {
    id: "laringe-38",
    question: "Assinale a alternativa CORRETA sobre o músculo cricotireóideo:",
    options: ['É inervado pelo nervo laríngeo recorrente.', 'É o único músculo intrínseco inervado pelo nervo laríngeo externo.', 'Sua função principal é abrir a glote para a respiração.', 'Origina-se na cartilagem epiglote.'],
    correctAnswer: 1,
    explanation: "Ele é a única exceção à inervação motora do recorrente na laringe.",
    theme: "Laringe"
   },
   {
    id: "laringe-39",
    ...
    correctAnswer: 2,
    explanation: "As cartilagens tritíceas situam-se nos ligamentos laterais da membrana tireo-hióidea.",
    theme: "Laringe"
   },
   {
    id: "laringe-40",
    question: "Qual músculo fecha o ádito da laringe para evitar que alimento entre na via aérea?",
    options: ['Tireoepiglótico.', 'Ariepiglótico.', 'Vocal.', 'Estilofaríngeo.'],
    correctAnswer: 1,
    explanation: "O ariepiglótico fecha o ádito; o tireoepiglótico o abre.",
    theme: "Laringe"
   }
  ]
 },
  ...
  questions: [
   {
    ...
    options: ['Situa-se na região anterior do pescoço.', 'Localiza-se ao nível das vértebras C5 a T1.', 'Consiste em dois lobos unidos por um istmo mediano.', 'O istmo localiza-se tipicamente anterior à cartilagem tireoide.'],
    correctAnswer: 3,
   ...
   },
   {
    ...
    correctAnswer: 1,
    explanation: "O lobo piramidal projeta-se superiormente a partir do istmo.",
    theme: "Tireoide"
   },
   {
    id: "tireoide-43",
    ...
    correctAnswer: 1,
    explanation: "Os lobos são cobertos pelos músculos esternotireóideos.",
    theme: "Tireoide"
   },
   {
    id: "tireoide-44",
    question: "Assinale a alternativa que descreve CORRETAMENTE o suprimento arterial da tireoide:",
    options: ['A artéria tireóidea superior deriva da artéria subclávia.', 'A artéria tireóidea inferior origina-se da artéria carótida externa.', 'A artéria tireóidea ima, quando presente, pode vir do tronco braquiocefálico ou arco aórtico.', 'O tronco tireocervical irriga exclusivamente o lobo piramidal.'],
    correctAnswer: 2,
   ...
   },
   {
    ...
    options: ['As veias tireóideas superiores drenam para a jugular interna.', 'As veias tireóideas médias drenam para a jugular interna.', 'As veias tireóideas inferiores drenam para a veia jugular externa.', 'As veias tireóideas inferiores drenam para as veias braquiocefálicas.'],
    correctAnswer: 2,
   ...
   },
   {
    ...
    options: ['São pequenas, marrom-amareladas e lentiformes.', 'Tipicamente, existem duas de cada lado.', 'Localizam-se entre a superfície posterior da tireoide e sua cápsula.', 'Localizam-se anteriormente à cartilagem tireoide.'],
    correctAnswer: 3,
   ...
   },
   {
    ...
    correctAnswer: 1,
    explanation: "Deriva do tronco tireocervical, ramo da subclávia.",
    theme: "Tireoide"
   },
   {
    id: "tireoide-48",
    ...
    correctAnswer: 1,
    explanation: "Essa é a posição clássica do istmo.",
    theme: "Tireoide"
   },
   {
    id: "tireoide-49",
    ...
    correctAnswer: 1,
    explanation: "A laríngea superior nasce da tireóidea superior.",
    theme: "Tireoide"
   },
   {
    id: "tireoide-50",
    question: "Qual a relação íntima do nervo laríngeo recorrente com a glândula tireoide?",
    options: ['Passa anteriormente ao istmo.', 'Ascende no sulco traqueoesofágico, posterior aos lobos da glândula.', 'Perfura o lobo piramidal.', 'Origina-se dentro da cápsula da tireoide.'],
    correctAnswer: 1,
    explanation: "Ascende no sulco traqueoesofágico, posterior aos lobos da glândula.",
    theme: "Tireoide"
   },
   {
    id: "tireoide-51",
    ...
    correctAnswer: 2,
    explanation: "Os lobos são cônicos e suas bases atingem o nível do 4º ou 5º anel.",
    theme: "Tireoide"
   },
   {
    id: "tireoide-52",
    ...
    correctAnswer: 1,
    explanation: "A superior e a média são tributárias da jugular interna; a inferior vai para a braquiocefálica.",
    theme: "Tireoide"
   },
   {
    id: "tireoide-53",
    ...
    correctAnswer: 1,
    explanation: "As superfícies mediais dos lobos fixam-se à cricoide.",
    theme: "Tireoide"
   },
   {
    id: "tireoide-54",
    ...
    correctAnswer: 2,
    explanation: "É uma variação arterial importante.",
    theme: "Tireoide"
   },
   {
    id: "tireoide-55",
    question: "Assinale a alternativa INCORRETA sobre a glândula tireoide:",
    options: ['É uma glândula endócrina.', 'Produz os hormônios T3 e T4.', 'Sua drenagem linfática é inexistente.', 'Situa-se profundamente aos músculos esternotireóideos.'],
    correctAnswer: 2,
    explanation: "Como qualquer órgão, possui drenagem linfática (embora não detalhada nos slides curtos, a afirmação de que é inexistente é anatomicamente falsa).",
    theme: "Tireoide"
   }
  ]
 },
  ...
  questions: [
   {
    ...
    correctAnswer: 1,
    explanation: "Maxilar, zigomático e palatino formam o assoalho orbital.",
    theme: "Olho"
   },
   {
    id: "olho-22",
    ...
    correctAnswer: 1,
    explanation: "O m. constritor faz miose via fibras parassimpáticas do III par.",
    theme: "Olho"
   },
   {
    id: "olho-23",
    ...
    correctAnswer: 2,
    explanation: "A lágrima vai do saco lacrimal para o ducto nasolacrimal (até o nariz).",
    theme: "Olho"
   },
   {
    id: "olho-24",
    ...
    correctAnswer: 1,
    explanation: "O reto lateral faz abdução e é inervado pelo VI par (abducente).",
    theme: "Olho"
   },
   {
    id: "olho-25",
    ...
    correctAnswer: 2,
    explanation: "A úvea é a camada vascular média: corioide, corpo ciliar e íris.",
    theme: "Olho"
   },
   {
    id: "olho-26",
    ...
    correctAnswer: 0,
    explanation: "O m. orbicular fecha o olho e é inervado pelo facial (VII).",
    theme: "Olho"
   },
   {
    id: "olho-27",
    ...
    correctAnswer: 2,
    explanation: "O canal óptico é a passagem do nervo óptico e artéria oftálmica.",
    theme: "Olho"
   },
   {
    id: "olho-28",
    ...
    correctAnswer: 1,
    explanation: "O humor aquoso preenche as câmaras anterior e posterior.",
    theme: "Olho"
   },
   {
    id: "olho-29",
    ...
    correctAnswer: 2,
    explanation: "O cristalino é a lente material que ajusta o foco.",
    theme: "Olho"
   },
   {
    id: "olho-30",
    ...
    correctAnswer: 1,
    explanation: "O oblíquo superior (OS 4) faz depressão com adução.",
    theme: "Olho"
   },
   {
    id: "olho-31",
    ...
    correctAnswer: 1,
    explanation: "A artéria central da retina é o ramo vital para a túnica interna.",
    theme: "Olho"
   },
   {
    id: "olho-32",
    ...
    correctAnswer: 3,
    explanation: "O assoalho é formado por maxilar, zigomático e palatino, não etmoide.",
    theme: "Olho"
   },
   {
    id: "olho-33",
    ...
    correctAnswer: 2,
    explanation: "A câmara postrema (ou vítrea) contém o humor vítreo.",
    theme: "Olho"
   },
   {
    id: "olho-34",
    ...
    correctAnswer: 2,
    explanation: "O músculo ciliar altera a conformação do cristalino para acomodação.",
    theme: "Olho"
   },
   {
    id: "olho-35",
    ...
    correctAnswer: 1,
    explanation: "As veias oftálmicas drenam principalmente para o seio cavernoso.",
    theme: "Olho"
   },
   {
    id: "olho-36",
    ...
    correctAnswer: 1,
    explanation: "As glândulas de Meibomius são glândulas sebáceas palpebrais/tarsais.",
    theme: "Olho"
   },
   {
    id: "olho-37",
    ...
    correctAnswer: 1,
    explanation: "O reto inferior realiza depressão com adução.",
    theme: "Olho"
   },
   {
    id: "olho-38",
    ...
    correctAnswer: 2,
    explanation: "O ramo V1 (oftálmico) é o responsável pela região orbital.",
    theme: "Olho"
   },
   {
    id: "olho-39",
    ...
    correctAnswer: 1,
    explanation: "Túnica fibrosa (externa) = córnea + esclera.",
    theme: "Olho"
   },
   {
    id: "olho-40",
    ...
    correctAnswer: 0,
    explanation: "O oculomotor (III) inerva quase todos, exceto o Oblíquo Superior (IV) e Reto Lateral (VI).",
    theme: "Olho"
   },
   {
    id: "olho-41",
    ...
    correctAnswer: 0,
    explanation: "A parede medial é composta pelos ossos frontal, etmoide, lacrimal e maxilar.",
    theme: "Olho"
   },
   {
    id: "olho-42",
    ...
    correctAnswer: 1,
    explanation: "O Oblíquo Superior (OS 4) é o músculo que faz depressão com adução, inervado pelo nervo Troclear.",
    theme: "Olho"
   },
   {
    id: "olho-43",
    ...
    correctAnswer: 1,
    explanation: "A miose (constrição) é feita pelo m. constritor da pupila via fibras parassimpáticas do III par.",
    theme: "Olho"
   },
   {
    id: "olho-44",
    ...
    correctAnswer: 2,
    explanation: "Após os canalículos, a lágrima cai no saco lacrimal antes de descer pelo ducto nasolacrimal.",
    theme: "Olho"
   },
   {
    id: "olho-45",
    ...
    correctAnswer: 1,
    explanation: "A úvea (vascular) é composta por corioide, corpo ciliar e íris.",
    theme: "Olho"
   },
   {
    id: "olho-46",
    ...
    correctAnswer: 1,
    explanation: "As glândulas sebáceas palpebrais mencionadas são as de Meibomius (tarsais) e as de Zeis.",
    theme: "Olho"
   },
   {
    id: "olho-47",
    ...
    options: ['Entre a córnea e a íris; humor aquoso.', 'Entre a íris e o cristalino; humor aquoso.', 'Após o cristalino; humor vítreo.', 'Entre a esclera e a corioide; perilinfa.'],
    correctAnswer: 1,
    explanation: "A câmara posterior fica entre a face posterior da íris e a face anterior do cristalino, contendo humor aquoso.",
    theme: "Olho"
   },
   {
    id: "olho-48",
    ...
    correctAnswer: 2,
    explanation: "O canal óptico é a passagem para o nervo óptico (II) e artéria oftálmica.",
    theme: "Olho"
   },
   {
    id: "olho-49",
    ...
    correctAnswer: 1,
    explanation: "O levantador da pálpebra superior é inervado pelo III par (Oculomotor).",
    theme: "Olho"
   },
   {
    id: "olho-50",
    ...
    correctAnswer: 1,
    explanation: "A artéria central da retina é o ramo da oftálmica que perfura o nervo óptico para nutrir a retina.",
    theme: "Olho"
   }
  ]
 }
